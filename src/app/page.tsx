...
import { PlusIcon, PrinterIcon, DocumentArrowDownIcon, ArrowUpOnSquareIcon } from '@heroicons/react/20/solid';
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 xl:grid-cols-3">
          {steps.map((step, index) => (
            <StepComponent
              ...
              onMoveCard={(cardIndex, direction) => {
                if (direction === 'left') moveCardLeft(index, cardIndex);
                else moveCardRight(index, cardIndex);
              }}
              onDeleteCard={(cardIndex) => deleteCard(index, cardIndex)}
